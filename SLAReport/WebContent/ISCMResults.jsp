        ...
        <display:table export="true" name="resultList" uid="data" requestURI="" pagesize="100">
         <display:column property="issueKey" title="IssueKey" sortable="true" />
            <display:column property="issueServiceName" title="ServiceName" sortable="true"  />
             <display:column property="issueProcurementType" title="ProcurementType" sortable="true"  />
            <display:column property="issueBusinessUnit" title="BusinessUnit" sortable="true"  />
            <display:column property="siteName" title="HOS Site Name" sortable="true"  />
            <display:column property="issueReporter" title="Reporter" sortable="true"  />
            <display:column property="commodity" title="Commodity" sortable="true"  />
            <display:column property="summary" title="DetailedDescription" sortable="true"  />
            ...
            <display:column property="issueTargetSLA" title="Target SLA(in hours)" sortable="true"  />
            <display:column property="issueOpenDate" title="IssueOpenDate" sortable="true"  />
            <display:column property="issueAgeing" title="Ageing(in hours)" sortable="true"  />
            ...
            <display:column property="responseTime" title="Response(in Mins)" sortable="true"  />           
            <display:column property="resolutionTime" title="Resolution(in Mins)" sortable="true"  />
            ...
            <display:column property="issueReOpenReason" title="Reason for Reopen" sortable="true"  />
            <display:column property="issueRejectReason" title="Reason for Rejection" sortable="true"  />
        </display:table>  
