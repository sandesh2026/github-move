     ...
     <s:set  value="resultList" scope="request" name="resultList"/>
        <display:table export="true" name="resultList" uid="data" requestURI="" pagesize="100">
         <display:column property="issueKey" title="IssueKey" sortable="true" />
            ...
            <display:column property="issueReporter" title="Requestor" sortable="true"  />
            <display:column property="networkNumber" title="NetworkNumber" sortable="true"  />
            <display:column property="activityNumber" title="ActivityNumber" sortable="true"  />
            <display:column property="ioNumber" title="IONumber" sortable="true"  />
            <display:column property="ccNumber" title="CCNumber" sortable="true"  />
